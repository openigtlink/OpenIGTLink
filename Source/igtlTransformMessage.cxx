...
namespace igtl {
  ...
  int TransformMessage::GetBodyPackSize()
  {
    ...
    {
      return IGTL_TRANSFORM_SIZE + IGTL_EXTENDED_HEADER_SIZE + GetMetaDataSize();
    }
    else
    {
  ...
  int TransformMessage::PackBody()
  {
    ...
    if (m_Version == IGTL_HEADER_VERSION_3)
    {
      memcpy((void*)(this->m_Transform+IGTL_EXTENDED_HEADER_SIZE), (void*)transform, sizeof(igtl_float32)*12);
    }
    else
    {
  ...
  int TransformMessage::UnpackBody()
  {
    ...
    if (m_Version == IGTL_HEADER_VERSION_3)
    {
      memcpy((void*)transform, (void*)(this->m_Transform+IGTL_EXTENDED_HEADER_SIZE), sizeof(igtl_float32)*12);
    }
    else
    {
