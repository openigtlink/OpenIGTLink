...
unsigned char test_polydata_message_headerWithRGBA[] = {
  /*------- OpenIGTLink message header --------*/
  0x00, 0x01,                                     /* Version number */
  0x50, 0x4f, 0x4c, 0x59, 0x44, 0x41, 0x54, 0x41,
  0x00, 0x00, 0x00, 0x00,                         /* POLYDATA */
  ...
  0x9A, 0x86, 0x5A, 0x17, 0x4C, 0xB1, 0x76, 0x4C, /* CRC */
};
...
unsigned char test_polydata_message_bodyWithRGBA[] =
{
  ...
  0x64,                                           /* Attribute #0 Type (upper 8bit) - type */
  ...
  0x61, 0x74, 0x74, 0x72,
  0x52, 0x47, 0x42,                               /* Attribute #1 - name */
  0x00,                                           /* Name string terminater */
  0x00,                                           /* Zero Padding */
  ...
  0x0A, 0x0A, 0x14, 0x01,                         /* RGBA #0 */
  0x0F, 0x14, 0x1E, 0x01,                         /* RGBA #1 */
  0x12, 0x7A, 0x01, 0x01,                         /* RGBA #2 */
  0x00, 0x01, 0x00, 0x01,                         /* RGBA #3 */
  0x0A, 0x0A, 0x64, 0x01,                         /* RGBA #4 */
  0xDD, 0x14, 0x3D, 0x01,                         /* RGBA #5 */
  0x07, 0x51, 0x01, 0x01,                         /* RGBA #6 */
  0x5A, 0x0A, 0x12, 0x01,                         /* RGBA #7 */
